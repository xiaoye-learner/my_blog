<template>
    <div class="blog-album">
        <div class="blog-album-header">
            <img :src="albumBg" alt="页首图片" style="width: 100%; height: 100%; object-fit: cover; filter: brightness(0.6);"/>
            <h1>相册</h1>
        </div>
        <el-tabs :tab-position="tabPosition" style="height: 100vh" class="demo-tabs">
            <el-tab-pane label="Anime">
                <div class="masonry-container" v-if="photo_anime_list.length">
                    <div class="masonry-item" v-for="(item, index) in photo_anime_list" :key="index">
            ...
            <el-tab-pane label="生活">
                 <div class="masonry-container" v-if="photo_life_list.length">
                    <div class="masonry-item" v-for="(item, index) in photo_life_list" :key="index">
                        <el-card class="photo_list-card" :body-style="{ padding: '0px' }">
                            <img :src="item.image" :alt="item.image" style="width: 100%; display: block;"></img>
                        </el-card>
                    </div>
                </div>
            </el-tab-pane>
